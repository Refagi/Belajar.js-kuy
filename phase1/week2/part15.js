/* 
Node.js memiliki beberapa modul bawaan (internal modules) yang menyediakan berbagai fungsionalitas yang 
berguna untuk pengembangan aplikasi. Berikut adalah beberapa modul bawaan yang umum digunakan, beserta contoh 
implementasinya dengan pendekatan synchronous:
...
/*
Catatan:
Penting untuk diingat bahwa metode synchronous (dengan menggunakan callback) dalam modul-modul bawaan 
Node.js mungkin tidak akan cocok untuk aplikasi yang perlu bersifat non-blocking. Biasanya, pendekatan 
asynchronous lebih disarankan untuk menghindari menghambat kinerja aplikasi dan memastikan responsivitas 
yang lebih baik.

Penggunaan metode asynchronous (async/await atau menggunakan callback) lebih umum dalam pengembangan Node.js 
yang sesuai dengan model non-blocking yang ada pada lingkungan tersebut.
 */